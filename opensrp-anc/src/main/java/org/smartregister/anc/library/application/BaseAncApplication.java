...
public class BaseAncApplication extends DrishtiApplication implements TimeChangedBroadcastReceiver.OnTimeChangedListener {

    private static final String TAG = BaseAncApplication.class.getCanonicalName();
    ...
    public static synchronized BaseAncApplication getInstance() {
        return (BaseAncApplication) DrishtiApplication.mInstance;
    }
    ...
    public Setting getCharactersitics(String characteristics) {
        return BaseAncApplication.getInstance().getContext().allSettings().getSetting(characteristics);
    }
