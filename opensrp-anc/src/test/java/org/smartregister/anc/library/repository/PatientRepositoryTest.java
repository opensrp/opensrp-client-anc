...
public class PatientRepositoryTest {
    ...
    public void testUpdateWomanDetailsInvokesUpdateMethodOfWritableDatabase() {
        ...
        String sql = "SELECT first_name,last_name,dob,dob_unknown,ec_mother_details.phone_number,ec_mother_details.alt_name,ec_mother_details.alt_phone_number,ec_client.base_entity_id,register_id,ec_mother_details.reminders,home_address,ec_mother_details.edd,ec_mother_details.contact_status,ec_mother_details.previous_contact_status,ec_mother_details.next_contact,ec_mother_details.next_contact_date,ec_mother_details.visit_start_date,ec_mother_details.red_flag_count,ec_mother_details.yellow_flag_count,ec_mother_details.last_contact_record_date,ec_client.relationalid FROM ec_client join ec_mother_details on ec_client.base_entity_id = ec_mother_details.base_entity_id WHERE ec_client.base_entity_id = ?";
