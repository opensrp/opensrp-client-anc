...
public class AdvancedSearchModelTest extends BaseUnitTest {
    ...
    public void testCreateSearchString() {
        ...
        String searchString = model.createSearchString(context, firstName, lastName, ancId, edd, dob, phoneNumber, alternateContact);
    ...
    public void testCreateSearchStringWithOneField() {
        String firstName = "first_name";
        String searchString = model.createSearchString(context, firstName, null, null, null, "", "", "");
    ...
    public void testCreateSearchStringWithSomeFields() {
        ...
        String searchString = model.createSearchString(context,null,  lastName, null, edd, "", phoneNumber, "");
