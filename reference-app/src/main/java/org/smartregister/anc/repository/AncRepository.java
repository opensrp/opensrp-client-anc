...
public class AncRepository extends Repository {
    ...
    private void upgradeToVersion4(SQLiteDatabase db) {
        try {
            db.execSQL("ALTER TABLE " + DBConstantsUtils.DEMOGRAPHIC_TABLE_NAME + " ADD COLUMN " + DBConstantsUtils.KeyUtils.UID_REPEAT + " VARCHAR");
            db.execSQL("ALTER TABLE " + DBConstantsUtils.DEMOGRAPHIC_TABLE_NAME + " ADD COLUMN " + DBConstantsUtils.KeyUtils.SSN_REPEAT + " VARCHAR");
            db.execSQL("ALTER TABLE " + DBConstantsUtils.DEMOGRAPHIC_TABLE_NAME + " ADD COLUMN " + DBConstantsUtils.KeyUtils.ADDITIONAL_ID_TYPE + " VARCHAR");
            db.execSQL("ALTER TABLE " + DBConstantsUtils.DEMOGRAPHIC_TABLE_NAME + " ADD COLUMN " + DBConstantsUtils.KeyUtils.ADDITIONAL_ID_NUMBER + " VARCHAR");
            db.execSQL("ALTER TABLE " + DBConstantsUtils.DEMOGRAPHIC_TABLE_NAME + " ADD COLUMN " + DBConstantsUtils.KeyUtils.ADDITIONAL_ID_NUMBER_REPEAT + " VARCHAR");
            db.execSQL("ALTER TABLE " + DBConstantsUtils.DEMOGRAPHIC_TABLE_NAME + " ADD COLUMN " + DBConstantsUtils.KeyUtils.PHONE_NUMBER + " VARCHAR");
            db.execSQL("ALTER TABLE " + DBConstantsUtils.DEMOGRAPHIC_TABLE_NAME + " ADD COLUMN " + DBConstantsUtils.KeyUtils.PHONE_NUMBER_REPEAT + " VARCHAR");
        } catch (Exception e) {
