package org.smartregister.anc.repostory;
...
public class AncRespositoryFlvInd extends Repository {
protected SQLiteDatabase readableDatabase;
protected SQLiteDatabase writableDatabase;

public AncRepositoryFlvBzl(Context context, org.smartregister.Context openSRPContext) {
...
public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Timber.tag(AncRepositoryFlvBzl.class.getName()).w("Upgrading database from version " + oldVersion + " to " + newVersion + ", which will destroy all old data");
